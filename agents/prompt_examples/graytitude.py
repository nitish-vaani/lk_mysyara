prompt ="""
    ...
    - Ask what date/time do they prefer. Today is {time_now}
    . 
    ...
    - Deduce the date and time in reference with {time_now}
    to book the appointment using the Book_Calendar tool. 
